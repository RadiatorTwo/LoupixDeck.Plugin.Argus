...
internal static class TileDrawing
{
    ...
    /// <summary>The "Argus Monitor is not running" screen.</summary>
    public static void Unavailable(PixelSurface surface, string title) =>
        Placeholder(surface, title, "ARGUS", "NOT RUNNING");

    /// <summary>Argus runs but reports nothing for this tile (e.g. network monitoring is off).</summary>
